...
let
  terminal = "ghostty";
  tmux = "ghostty -e tmux new-session -A -s 'main'";
  menu = "otter-open";
  browser = (import ./var.nix).browser.command;
  ...
  fileManager = "ghostty -e bash -ci 'yazi; exit'";
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      hl.on("hyprland.start", function()
        ...
        hl.exec_cmd("otter-apps --refresh-cache")
        ...
        hl.exec_cmd("ghostty --class=com.otter.launcher --initial-window=false --quit-after-last-window-closed=false --gtk-single-instance=true")
      end)

...
# full user config (keybinds, autostart, rules). Rule 4 deps:
# modules/_assets/documentation/module-contracts.md (C8/C9).
# ==========================================================================
{ inputs, ... }:
let
  noctaliaPackage = inputs.noctalia.packages.x86_64-linux.default;
in
{
